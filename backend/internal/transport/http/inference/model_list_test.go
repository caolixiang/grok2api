...
func TestNewModelListItemsWithToolsAdvertisesConsoleOnly(t *testing.T) {
	...
	if items[0].XGrok == nil || len(items[0].XGrok.ServerTools) != 4 || items[0].XGrok.ServerTools[0] != "web_search" || items[0].XGrok.ServerTools[1] != "x_search" || items[0].XGrok.ServerTools[2] != "image_generation" || items[0].XGrok.ServerTools[3] != "code_execution" {
...
func TestCodexCatalogAdvertisesConsoleServerToolsOnly(t *testing.T) {
	consoleEntry := newCodexModelCatalog([]modelListItem{{
		...
		XGrok: &modelToolMetadata{ServerTools: []string{"web_search", "x_search", "image_generation", "code_execution"}},
	}}).Models[0]
	if !consoleEntry.SupportsSearchTool || len(consoleEntry.ExperimentalSupportedTools) != 4 || consoleEntry.ExperimentalSupportedTools[0] != "web_search" || consoleEntry.ExperimentalSupportedTools[1] != "x_search" || consoleEntry.ExperimentalSupportedTools[2] != "image_generation" || consoleEntry.ExperimentalSupportedTools[3] != "code_execution" {
	...
	if !sharedEntry.SupportsSearchTool || len(sharedEntry.ExperimentalSupportedTools) != 4 || sharedEntry.ExperimentalSupportedTools[2] != "image_generation" || sharedEntry.ExperimentalSupportedTools[3] != "code_execution" {
