...
const modelRouteValidator = hasShape({
  ...
  serverTools: isOptional(isArrayOf(isOneOf("web_search", "x_search"))),
...
const decodeModelRoute = createObjectDecoder<ModelRouteDTO>("model route", {
  ...
  capability: isOneOf("responses", "chat", "image", "image_edit", "video", "tts", "stt", "realtime"), serverTools: isOptional(isArrayOf(isOneOf("web_search", "x_search"))), origin: isOneOf("catalog", "discovered", "manual"),
